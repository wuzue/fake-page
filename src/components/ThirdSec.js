      ...
      <div className='top-container'>
        <div className='top-body'>
          <div className='top-left-side'>
           <p className='titulo-para-quem'>Para quem é o Nômade Digital?</p>
